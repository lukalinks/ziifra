...
<body @class([
    ...
    <div class="min-h-screen min-h-[100dvh]">
        ...
        <div class="relative min-w-0 md:pl-64">
            <header class="sticky top-0 z-30 flex h-16 shrink-0 items-center justify-between gap-3 border-b border-ziifra-line/80 bg-ziifra-paper/80 px-4 backdrop-blur-xl md:px-8">
                <div class="flex min-w-0 flex-1 items-center gap-3">
                    <div class="md:hidden shrink-0">
                        <x-ziifra-logo href="{{ $billingOrg ? \App\Support\Workspace::route('dashboard', $billingOrg) : route('workspace.dashboard') }}" variant="auto" data-page-nav />
                    </div>
                    <div class="min-w-0 flex-1 md:pl-0">
            ...
            <main class="ziifra-main flex-1 p-4 md:p-8">
